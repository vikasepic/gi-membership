...
export const BLOCK_CONTROLS: Record<BlockType, BlockControls> = {
  ...
  prices: {
    ...
    style: [
      ...
      { kind: "number", key: "termsSize", label: "Terms size", min: 8, max: 32, step: 1, unit: "px" },
      group("Words"),
      {
        kind: "select",
        key: "align",
        label: "Align",
        hint: "The heading, note and decline link. The option rows stay left — a radio lives on the left, and centring the words beside it opens a gap between the control and what it controls.",
        options: [["left", "Left"], ["center", "Centre"], ["right", "Right"]],
      },
      { kind: "color", key: "headingColor", label: "Heading", hint: "Unset follows the band." },
      ...
      { kind: "number", key: "buttonSize", label: "Label size", min: 10, max: 32, step: 1, unit: "px" },
      ...TYPOGRAPHY,
    ],
  },
  ...
  pricing: {
    content: [
      ...
      group("Header row"),
      { kind: "text", key: "headLabel", label: "Left", hint: "e.g. “What you get”. Blank draws no header." },
      { kind: "text", key: "headAmount", label: "Right", hint: "e.g. “Value”." },
      { kind: "select", key: "headFont", label: "Font", options: [["", "Page default"]] },
      { kind: "number", key: "headSize", label: "Size", min: 8, max: 72, step: 1, unit: "px", responsive: true, hint: "Unset keeps the size it has." },
      { kind: "color", key: "headColor", label: "Left colour", hint: "Unset follows the band." },
      { kind: "color", key: "headAmountColor", label: "Right colour", hint: "Unset matches the left." },
      group("Rows"),
      { kind: "number", key: "rowPadY", label: "Row padding, top and bottom", min: 0, max: 80, step: 1, unit: "px", responsive: true, hint: "Unset keeps the 12px it has." },
      { kind: "number", key: "rowPadX", label: "Row padding, sides", min: 0, max: 80, step: 1, unit: "px", responsive: true, hint: "Unset keeps the 16px it has." },
      { kind: "number", key: "ruleWidth", label: "Rule between rows", min: 0, max: 8, step: 1, unit: "px", responsive: true, hint: "Unset draws the band's hairline." },
      { kind: "color", key: "ruleColor", label: "Rule colour", hint: "Unset follows the band." },
      group("Line text"),
      { kind: "select", key: "labelFont", label: "Font", options: [["", "Page default"]] },
      { kind: "number", key: "labelSize", label: "Size", min: 8, max: 120, step: 1, unit: "px", responsive: true, hint: "Unset keeps the size it has." },
      { kind: "select", key: "labelWeight", label: "Weight", options: [["", "Inherit"], ...["300", "400", "500", "600", "700", "800", "900"].map((w) => [w, w] as [string, string])] },
      { kind: "color", key: "labelColor", label: "Colour", hint: "Unset follows the band." },
      group("Amounts"),
      { kind: "select", key: "amountFont", label: "Font", options: [["", "Page default"]] },
      { kind: "number", key: "amountSize", label: "Size", min: 8, max: 120, step: 1, unit: "px", responsive: true, hint: "Unset keeps the size it has." },
      { kind: "select", key: "amountWeight", label: "Weight", options: [["", "Inherit"], ...["300", "400", "500", "600", "700", "800", "900"].map((w) => [w, w] as [string, string])] },
      { kind: "color", key: "amountColor", label: "Colour", hint: "Unset follows the band." },
      group("Total row"),
      { kind: "select", key: "totalFont", label: "Font", options: [["", "Page default"]] },
      { kind: "number", key: "totalLabelSize", label: "Label size", min: 8, max: 72, step: 1, unit: "px", responsive: true, hint: "Unset keeps the size it has." },
      { kind: "number", key: "totalAmountSize", label: "Amount size", min: 8, max: 96, step: 1, unit: "px", responsive: true, hint: "Unset keeps the size it has." },
      { kind: "select", key: "totalWeight", label: "Weight", options: [["", "Inherit"], ...["300", "400", "500", "600", "700", "800", "900"].map((w) => [w, w] as [string, string])] },
      { kind: "color", key: "totalColor", label: "Colour", hint: "Unset follows the band." },
      { kind: "number", key: "totalRuleWidth", label: "Rule above", min: 0, max: 8, step: 1, unit: "px", responsive: true, hint: "Unset keeps the 2px it has." },
    ],
    style: [...TYPOGRAPHY],
  },
  ...
  pricecard: {
    content: [
      ...
      group("Card"),
      {
        ...
        key: "skin",
        label: "Layout",
        options: [["classic", "Classic"], ["panel", "Two-tone panel"]],
        hint: "The panel adds a title, a struck regular price, a label over the price, and a darker footer for the button.",
      },
      { kind: "text", key: "title", label: "Title", hint: "The line at the top, e.g. “Join Digital Product Business System”.", when: (b) => b.props.skin === "panel" },
      { kind: "text", key: "compareLabel", label: "Regular price label", hint: "e.g. “Regular Price”. Blank hides the struck price.", when: (b) => b.props.skin === "panel" },
      { kind: "text", key: "comparePrice", label: "Regular price", hint: "Leave empty to show the offer's own compare-at price. Struck through.", when: (b) => b.props.skin === "panel" },
      { kind: "text", key: "priceLabel", label: "Price label", hint: "e.g. “Early Access Price”.", when: (b) => b.props.skin === "panel" },
      { kind: "text", key: "altPrefix", label: "Before the second price", hint: "e.g. “Or”. The second price is the offer's payment plan when it has one.", when: (b) => b.props.skin === "panel" },
      { kind: "toggle", key: "altItalic", label: "Second price in italics", when: (b) => b.props.skin === "panel" },
      { kind: "color", key: "cardColor", label: "Card colour", hint: "Unset follows the band.", when: (b) => b.props.skin === "panel" },
      { kind: "number", key: "cardRadius", label: "Corner", min: 0, max: 64, step: 1, unit: "px", responsive: true, hint: "Unset keeps 20px.", when: (b) => b.props.skin === "panel" },
      { kind: "dim", key: "cardPadding", label: "Card padding", hint: "Unset keeps what it has.", when: (b) => b.props.skin === "panel" },
      { kind: "color", key: "footerColor", label: "Footer colour", hint: "Behind the button and small print. Unset draws no footer.", when: (b) => b.props.skin === "panel" },
      { kind: "dim", key: "footerPadding", label: "Footer padding", when: (b) => b.props.skin === "panel" },
      group("Badge", (b) => b.props.skin === "panel"),
      { kind: "select", key: "badgePlace", label: "Place", options: [["inline", "Under the price"], ["top", "On the top edge"]], when: (b) => b.props.skin === "panel" },
      { kind: "toggle", key: "badgeUpper", label: "UPPERCASE", when: (b) => b.props.skin === "panel" },
      { kind: "select", key: "badgeFont", label: "Font", options: [["", "Page default"]], when: (b) => b.props.skin === "panel" },
      { kind: "number", key: "badgeSize", label: "Size", min: 8, max: 40, step: 1, unit: "px", responsive: true, when: (b) => b.props.skin === "panel" },
      { kind: "select", key: "badgeWeight", label: "Weight", options: [["", "Inherit"], ...["300", "400", "500", "600", "700", "800", "900"].map((w) => [w, w] as [string, string])], when: (b) => b.props.skin === "panel" },
      { kind: "color", key: "badgeBg", label: "Fill", hint: "Unset uses the band accent.", when: (b) => b.props.skin === "panel" },
      { kind: "color", key: "badgeColor", label: "Text colour", when: (b) => b.props.skin === "panel" },
      group("Title", (b) => b.props.skin === "panel"),
      { kind: "select", key: "titleFont", label: "Font", options: [["", "Page default"]], when: (b) => b.props.skin === "panel" },
      { kind: "number", key: "titleSize", label: "Size", min: 8, max: 120, step: 1, unit: "px", responsive: true, hint: "Unset keeps the size it has.", when: (b) => b.props.skin === "panel" },
      { kind: "select", key: "titleWeight", label: "Weight", options: [["", "Inherit"], ...["300", "400", "500", "600", "700", "800", "900"].map((w) => [w, w] as [string, string])], when: (b) => b.props.skin === "panel" },
      { kind: "color", key: "titleColor", label: "Colour", hint: "Unset follows the band.", when: (b) => b.props.skin === "panel" },
      group("Labels over the prices", (b) => b.props.skin === "panel"),
      { kind: "select", key: "labelFont", label: "Font", options: [["", "Page default"]], when: (b) => b.props.skin === "panel" },
      { kind: "number", key: "labelSize", label: "Size", min: 8, max: 120, step: 1, unit: "px", responsive: true, hint: "Unset keeps the size it has.", when: (b) => b.props.skin === "panel" },
      { kind: "select", key: "labelWeight", label: "Weight", options: [["", "Inherit"], ...["300", "400", "500", "600", "700", "800", "900"].map((w) => [w, w] as [string, string])], when: (b) => b.props.skin === "panel" },
      { kind: "color", key: "labelColor", label: "Colour", hint: "Unset follows the band.", when: (b) => b.props.skin === "panel" },
      group("Regular price, struck", (b) => b.props.skin === "panel"),
      { kind: "select", key: "compareFont", label: "Font", options: [["", "Page default"]], when: (b) => b.props.skin === "panel" },
      { kind: "number", key: "compareSize", label: "Size", min: 8, max: 120, step: 1, unit: "px", responsive: true, hint: "Unset keeps the size it has.", when: (b) => b.props.skin === "panel" },
      { kind: "select", key: "compareWeight", label: "Weight", options: [["", "Inherit"], ...["300", "400", "500", "600", "700", "800", "900"].map((w) => [w, w] as [string, string])], when: (b) => b.props.skin === "panel" },
      { kind: "color", key: "compareColor", label: "Colour", hint: "Unset follows the band.", when: (b) => b.props.skin === "panel" },
      { kind: "number", key: "compareLabelSize", label: "Regular price label size", min: 8, max: 72, step: 1, unit: "px", responsive: true, hint: "Unset matches the labels.", when: (b) => b.props.skin === "panel" },
      group("Price", (b) => b.props.skin === "panel"),
      { kind: "select", key: "priceFont", label: "Font", options: [["", "Page default"]], when: (b) => b.props.skin === "panel" },
      { kind: "number", key: "priceSize", label: "Size", min: 8, max: 160, step: 1, unit: "px", responsive: true, hint: "Unset keeps the size it has.", when: (b) => b.props.skin === "panel" },
      { kind: "select", key: "priceWeight", label: "Weight", options: [["", "Inherit"], ...["300", "400", "500", "600", "700", "800", "900"].map((w) => [w, w] as [string, string])], when: (b) => b.props.skin === "panel" },
      { kind: "color", key: "priceColor", label: "Colour", hint: "Unset follows the band.", when: (b) => b.props.skin === "panel" },
      group("Terms under the price", (b) => b.props.skin === "panel"),
      { kind: "select", key: "termsFont", label: "Font", options: [["", "Page default"]], when: (b) => b.props.skin === "panel" },
      { kind: "number", key: "termsSize", label: "Size", min: 8, max: 120, step: 1, unit: "px", responsive: true, hint: "Unset keeps the size it has.", when: (b) => b.props.skin === "panel" },
      { kind: "select", key: "termsWeight", label: "Weight", options: [["", "Inherit"], ...["300", "400", "500", "600", "700", "800", "900"].map((w) => [w, w] as [string, string])], when: (b) => b.props.skin === "panel" },
      { kind: "color", key: "termsColor", label: "Colour", hint: "Unset follows the band.", when: (b) => b.props.skin === "panel" },
      group("Small print", (b) => b.props.skin === "panel"),
      { kind: "select", key: "noteFont", label: "Font", options: [["", "Page default"]], when: (b) => b.props.skin === "panel" },
      { kind: "number", key: "noteSize", label: "Size", min: 8, max: 120, step: 1, unit: "px", responsive: true, hint: "Unset keeps the size it has.", when: (b) => b.props.skin === "panel" },
      { kind: "color", key: "noteColor", label: "Colour", hint: "Unset follows the band.", when: (b) => b.props.skin === "panel" },
      group("Button", (b) => b.props.skin === "panel"),
      { kind: "color", key: "buttonColor", label: "Fill", hint: "Unset uses the band accent.", when: (b) => b.props.skin === "panel" },
      { kind: "color", key: "buttonInk", label: "Text colour", when: (b) => b.props.skin === "panel" },
      { kind: "select", key: "buttonFont", label: "Font", options: [["", "Page default"]], when: (b) => b.props.skin === "panel" },
      { kind: "number", key: "buttonSize", label: "Size", min: 8, max: 40, step: 1, unit: "px", responsive: true, when: (b) => b.props.skin === "panel" },
      { kind: "select", key: "buttonWeight", label: "Weight", options: [["", "Inherit"], ...["300", "400", "500", "600", "700", "800", "900"].map((w) => [w, w] as [string, string])], when: (b) => b.props.skin === "panel" },
      { kind: "number", key: "buttonRadius", label: "Corner", min: 0, max: 64, step: 1, unit: "px", responsive: true, when: (b) => b.props.skin === "panel" },
      { kind: "number", key: "buttonPadX", label: "Padding, sides", min: 0, max: 80, step: 1, unit: "px", responsive: true, when: (b) => b.props.skin === "panel" },
      { kind: "number", key: "buttonPadY", label: "Padding, top and bottom", min: 0, max: 60, step: 1, unit: "px", responsive: true, when: (b) => b.props.skin === "panel" },
    ],
    style: [...TYPOGRAPHY],
  },
...
const FONT_KEYS = new Set([
  ...
  // The price table's rows and the price card's parts.
  "amountFont", "headFont", "totalFont", "badgeFont", "compareFont", "priceFont", "termsFont", "noteFont", "buttonFont",
]);
